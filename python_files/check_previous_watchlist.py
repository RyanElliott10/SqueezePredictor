...
tickers = []
check_dict = {}
prev_watchlist = '../watch_lists/' + str(today.year) + '/' + month + '/watch_lists' + '/watch_list_for_' + month + '_' + str(int(day)-1) + '_' + year + '.txt'
...
check_watchlist = '../watch_lists/' + str(today.year) + '/' + month + '/checked_watch_lists/' + month + '_' + (str(int(day)-1)) + '_' + year + '_checked.txt'
